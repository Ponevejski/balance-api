...
export class CategoriesBalanceCreatedAt1712836792291 implements MigrationInterface {
    name = 'CategoriesBalanceCreatedAt1712836792291'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "balance" ("id" SERIAL NOT NULL, "amount" integer NOT NULL, "description" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT '4/11/2024', "categoryId" integer NOT NULL, "authorId" integer, CONSTRAINT "PK_079dddd31a81672e8143a649ca0" PRIMARY KEY ("id"))`);
